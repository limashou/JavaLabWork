...
public class CurriculumWithStreams extends CurriculumWithArrayList {
    ...
    public static void main(String[] args) {
        ...
        List<Lecture> lectures = new ArrayList<>();
        lectures.add(new Lecture("First step in Java." , 24,"2021.09.04"));
        lectures.add(new Lecture("Work with files.", 19,"2021.09.28"));
        lectures.add(new Lecture("Arrays and list." , 20,"2021.11.03"));
        lectures.add(new Lecture("Simplex method." ,17,"2021.09.23"));
